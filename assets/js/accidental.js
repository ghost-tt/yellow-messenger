...
function handleAccountInfo(event) {
    console.log('handle Account Info', account_details)
    event.preventDefault();
    ...
    if (field_AccountName.length !== 0 && field_AccountNumber.length !== 0 && field_Bank.length !== 0 && field_Branch.length !== 0 && field_Currency.length !== 0 && file6.length !== 0) {
        const data = {
            field_AccountName,
            field_AccountNumber,
            field_Bank,
